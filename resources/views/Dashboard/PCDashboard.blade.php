...
<div class="main">
    ...
    <div class="topbar">
        <div class="page-title-wrap">
            <span class="page-title">{{ $agencyName }}</span>
            <svg class="page-title-arrow" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
                <polyline points="6 9 12 15 18 9"/>
            </svg>
            <span style="font-size:13px;color:#6b7280;font-weight:500">Program Coordinator</span>
        </div>
